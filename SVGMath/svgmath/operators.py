...
def createEntry( content, 
                 ...
                 accent = u"false",
                 largeop = u"false",
                 lspace = u"verythinmathspace", 
                 rspace = u"verythinmathspace",
                 stretchy = u"false", 
                 scaling = u"uniform", 
                 minsize = u"1", 
                 maxsize = u"infinity", 
...
# Crappy hax to ensure proper spacing for some functions
#createEntry (content=u"\u2B1C", form=u"infix", minsize=u"20px") # LargeWhiteSquare
createEntry (content=u"\u225F", form=u"infix", lspace=u"thickmathspace", rspace=u"thickmathspace") # Questioned Equal To
createEntry (content=u"\u23DE", form=u"postfix", accent=u"true", stretchy=u"true", scaling=u"horizontal", lspace=u"0em", rspace=u"0em") # Top Curly Bracket
createEntry (content="sin", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Sine
createEntry (content="cos", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Cosine
createEntry (content="tan", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Tangent
createEntry (content="csc", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Cosecant
createEntry (content="sec", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Secant
createEntry (content="cot", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # Cotangent
createEntry (content="sinh", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HSine
createEntry (content="cosh", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HCosine
createEntry (content="tanh", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HTangent
createEntry (content="csch", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HCosecant
createEntry (content="sech", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HSecant
createEntry (content="coth", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # HCotangent
createEntry (content="ln", form=u"infix", lspace=u"verythinmathspace", rspace=u"verythinmathspace") # LN
...
createEntry (content=u"|", form=u"infix", stretchy=u"true", scaling="vertical", lspace=u"verythinmathspace", rspace=u"verythinmathspace")
...
createEntry (content=u"\u00B0", form=u"postfix", lspace=u"0em", rspace=u"0em") # DegreeSign
# Added an entry for minus sign, separate from hyphen
createEntry (content=u"\u2212", form=u"prefix", lspace=u"0em", rspace=u"veryverythinmathspace")
createEntry (content=u"+", form=u"prefix", lspace=u"0em", rspace=u"veryverythinmathspace")
